...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -389.4197 / (Math.sin(θ) - 1.1624468 * Math.cos(θ));
    }
  }, {
    min: 4.9,
    max: 6.6,
    height: -1,
    r: function r(θ) {
      return 423.5471 / (Math.sin(θ) + 1.085346 * Math.cos(θ));
    }
  }, {
    min: 6.6,
    max: 31.7,
    height: -1,
    r: function r(θ) {
      return 6211.3885 / (Math.sin(θ) + 17.49780 * Math.cos(θ));
    }
  }, {
    min: 31.7,
    max: 32.9,
    height: -1,
    r: function r(θ) {
      return 427.9667 / (Math.sin(θ) + 0.630552 * Math.cos(θ));
    }
  }, {
    min: 32.9,
    max: 34,
    height: -1,
    r: function r(θ) {
      return 1197.8397 / (Math.sin(θ) + 2.9286229 * Math.cos(θ));
    }
  }, {
    min: 34,
    max: 38.9,
    height: -1,
    r: function r(θ) {
      return 559.10919 / (Math.sin(θ) + 1.0073058 * Math.cos(θ));
    }
  }, {
    min: 38.9,
    max: 39.1,
    height: -1,
    r: function r(θ) {
      return -91.557622 / (Math.sin(θ) - 1.10398508 * Math.cos(θ));
    }
  }, {
    min: 39.1,
    max: 50.5,
    height: -1,
    r: function r(θ) {
      return 571.02441 / (Math.sin(θ) + 1.007058 * Math.cos(θ));
    }
  }, {
    min: 50.5,
    max: 50.8,
    height: -1,
    r: function r(θ) {
      return 114.59269 / (Math.sin(θ) - 0.76826977 * Math.cos(θ));
    }
  }, {
    min: 50.8,
    max: 55.7,
    height: -1,
    r: function r(θ) {
      return 557.962 / (Math.sin(θ) + 1.0031979 * Math.cos(θ));
    }
  }, {
    min: 55.7,
    max: 56.7,
    height: -1,
    r: function r(θ) {
      return 403.8808 / (Math.sin(θ) + 0.3213439 * Math.cos(θ));
    }
  }, {
    min: 56.7,
    max: 57.7,
    height: -1,
    r: function r(θ) {
      return 755.17044 / (Math.sin(θ) + 1.924966 * Math.cos(θ));
    }
  }, {
    min: 57.7,
    max: 82.5,
    height: -1,
    r: function r(θ) {
      return 353.793768 / (Math.sin(θ) + 0.06108017 * Math.cos(θ));
    }
  }, {
    min: 82.5,
    max: 84.2,
    height: -1,
    r: function r(θ) {
      return 395.0241 / (Math.sin(θ) + 0.9533913 * Math.cos(θ));
    }
  }, {
    min: 84.2,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 327 / (Math.sin(θ) - 0.9060869 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/atlanta.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    r: function r(θ) {
      ...
      var n2 = 70449.05 * Math.sqrt(d - 74729.9 * Math.pow(Math.sin(θ - 0.7661995), 2));
      return n1 / d + n2 / d;
    }
  }]
};
exports.default = _default;
},{}],"js/baltimore.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -1786.977 / (Math.sin(θ) - 5.61942 * Math.cos(θ));
    }
  }, {
    min: 25.5,
    max: 49,
    height: -1,
    r: function r(θ) {
      return 801.702 / (Math.sin(θ) + 1.830 * Math.cos(θ));
    }
  }, {
    min: 49,
    max: 82,
    height: -1,
    r: function r(θ) {
      return 359.7761 / (Math.sin(θ) + 0.187168 * Math.cos(θ));
    }
  }, {
    min: 82,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 331 / (Math.sin(θ) - 0.396914 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/boston.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/chicagocubs.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      var d = 33526.25 - 9105.75 * Math.cos(2 * θ - Math.PI);
      var n1 = 9353823.75 * Math.cos(θ - 0.561996) - 2540504.25 * Math.cos(θ - 2.5621433);
      var n2 = 22815.51 * Math.sqrt(d - 155682 * Math.pow(Math.sin(θ - 0.561996), 2));
      return n1 / d + n2 / d;
    }
  }, {
    min: 49.2,
    ...
    height: -1,
    r: function r(θ) {
      return 357.8732 / (Math.sin(θ) + 0.245827 * Math.cos(θ));
    }
  }, {
    min: 73.2,
    max: 74.8,
...
exports.default = _default;
},{}],"js/chicagowhitesox.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -7014.6043 / (Math.sin(θ) - 20.930117 * Math.cos(θ));
    }
  }, {
    min: 24.1,
    max: 30.6,
    height: -1,
    r: function r(θ) {
      return 1495.6997 / (Math.sin(θ) + 3.92207 * Math.cos(θ));
    }
  }, {
    min: 30.6,
    max: 36.6,
    height: -1,
    r: function r(θ) {
      return 820.061 / (Math.sin(θ) + 1.88324 * Math.cos(θ));
    }
  }, {
    min: 36.6,
    max: 39.1,
    height: -1,
    r: function r(θ) {
      return 1969.1459 / (Math.sin(θ) + 5.562717 * Math.cos(θ));
    }
  }, {
    min: 39.1,
    max: 50.6,
    height: -1,
    r: function r(θ) {
      return 561.4969 / (Math.sin(θ) + 1.00525 * Math.cos(θ));
    }
  }, {
    min: 50.6,
    max: 54,
    height: -1,
    r: function r(θ) {
      return 363.2118 / (Math.sin(θ) + 0.2203438 * Math.cos(θ));
    }
  }, {
    min: 54,
    max: 58.7,
    height: -1,
    r: function r(θ) {
      return 426.18439 / (Math.sin(θ) + 0.49718 * Math.cos(θ));
    }
  }, {
    min: 58.7,
    max: 63.4,
    height: -1,
    r: function r(θ) {
      return 378.8179 / (Math.sin(θ) + 0.259128 * Math.cos(θ));
    }
  }, {
    min: 63.4,
    max: 79,
    height: -1,
    r: function r(θ) {
      return 340.82399 / (Math.sin(θ) + 0.03285 * Math.cos(θ));
    }
  }, {
    min: 79,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 327 / (Math.sin(θ) - 0.177146 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/cincinnati.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      var d = 41212.25 - 30987.75 * Math.cos(2 * θ - 3.31613);
      var n1 = 11951552.5 * Math.cos(θ - 0.439823) - 8986447.5 * Math.cos(θ - 2.8763026);
      var n2 = 19212.09 * Math.sqrt(d - 168200 * Math.pow(Math.sin(θ - 0.439823), 2));
      return n1 / d + n2 / d;
    }
  }, {
    min: 44.7,
    ...
    height: -1,
    r: function r(θ) {
      return 436.311 / (Math.sin(θ) + 0.52231577 * Math.cos(θ));
    }
  }, {
    min: 60.3,
    max: 86.6,
    height: -1,
    r: function r(θ) {
      return 336.435 / (Math.sin(θ) + 0.014347 * Math.cos(θ));
    }
  }, {
    min: 86.6,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 326 / (Math.sin(θ) - 0.5206001 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/cleveland.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: 9,
    r: function r(θ) {
      return -1609.844 / (Math.sin(θ) - 4.98404 * Math.cos(θ));
    }
  }, {
    min: 20.3,
    max: 48.25,
    height: 9,
    r: function r(θ) {
      return 906.183 / (Math.sin(θ) + 2.2274 * Math.cos(θ));
    }
  }, {
    min: 48.25,
    max: 78.25,
    height: 19,
    r: function r(θ) {
      return 356.7465 / (Math.sin(θ) + 0.197554 * Math.cos(θ));
    }
  }, {
    min: 78.25,
    max: 90,
    height: 19,
    r: function r(θ) {
      return 321 / (Math.sin(θ) - 0.303978 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/colorado.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -551.417 / (Math.sin(θ) - 1.57548 * Math.cos(θ));
    }
  }, {
    min: 1.25,
    max: 37.5,
    height: -1,
    r: function r(θ) {
      return 4061.537 / (Math.sin(θ) + 11.422 * Math.cos(θ));
    }
  }, {
    min: 37.5,
    max: 60.2,
    height: -1,
    r: function r(θ) {
      return 536.536 / (Math.sin(θ) + 0.84228 * Math.cos(θ));
    }
  }, {
    min: 60.2,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 345 / (Math.sin(θ) - 0.08135 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/detroit.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -405.584 / (Math.sin(θ) - 1.23813 * Math.cos(θ));
    }
  }, {
    min: 1.25,
    max: 22.5,
    ...
    height: -1,
    r: function r(θ) {
      return -430.4868 / (Math.sin(θ) - 1.6908 * Math.cos(θ));
    }
  }, {
    min: 24.6,
    max: 35.3,
    ...
    height: -1,
    r: function r(θ) {
      return 593.97 / (Math.sin(θ) + Math.cos(θ));
    }
  }, {
    min: 54,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 345 / Math.sin(θ);
    }
  }]
};
exports.default = _default;
},{}],"js/houston.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -2943.702 / (Math.sin(θ) - 9.23123 * Math.cos(θ));
    }
  }, {
    min: 33.7,
    max: 34,
    height: -1,
    r: function r(θ) {
      return 310.475 / (Math.sin(θ) + 0.23668 * Math.cos(θ));
    }
  }, {
    min: 34,
    max: 49.6,
    height: -1,
    r: function r(θ) {
      var d = 10525 - 725 * Math.cos(2 * θ);
      var n1 = 3820575 * Math.cos(θ - 0.7417649) - 263175 * Math.cos(θ + 0.7417649);
      var n2 = 7424.6 * Math.sqrt(d - 263538 * Math.pow(Math.sin(θ - 0.7417649), 2));
      return n1 / d + n2 / d;
    }
  }, {
    min: 49.6,
    ...
    height: -1,
    r: function r(θ) {
      return 42.673422 / (Math.sin(θ) - 2.121119 * Math.cos(θ));
    }
  }, {
    min: 67.9,
    max: 90,
...
exports.default = _default;
},{}],"js/kansascity.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    r: function r(θ) {
      ...
      var d = 5417 - 1545 * Math.cos(2 * θ - 3.14159);
      var n1 = 1738857 * Math.cos(θ - 0.1762783) - 495945 * Math.cos(θ - 2.9653144);
      var n2 = 3671.3 * Math.sqrt(d - 206082 * Math.pow(Math.sin(θ - 0.1762783), 2)) || 0;
      return n1 / d + n2 / d;
    }
  }, {
    min: 5.9,
    ...
    height: -1,
    r: function r(θ) {
      var d = 111634 - 10384 * Math.cos(2 * θ + 0.453786);
      var n1 = 19759218 * Math.cos(θ - 0.8883726) - 1837968 * Math.cos(θ + 1.342158);
      var n2 = 78594.9 * Math.sqrt(d - 62658 * Math.pow(Math.sin(θ - 0.8883726), 2));
      return n1 / d + n2 / d;
    }
  }, {
    min: 59,
    ...
    height: -1,
    r: function r(θ) {
      var d = 16218 - 14040 * Math.cos(2 * θ + 0.20944);
      var n1 = 5643864 * Math.cos(θ - 1.199041) - 4885920 * Math.cos(θ + 1.408481);
      var n2 = 5740.3 * Math.sqrt(d - 242208 * Math.pow(Math.sin(θ - 1.199041), 2));
      return n1 / d + n2 / d;
    }
  }, {
    min: 76.9,
    ...
    var d = 2897 - 975 * Math.cos(2 * θ - 0.663225);
    var n1 = 958907 * Math.cos(θ - 1.441642) - 322725 * Math.cos(θ + 0.7784168);
    var n2 = 1929 * Math.sqrt(d - 219122 * Math.pow(Math.sin(θ - 1.441642), 2));
    return n1 / d + n2 / d;
  })]
};
exports.default = _default;
},{}],"js/laangels.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -352.2388 / (Math.sin(θ) - 1.06739 * Math.cos(θ));
    }
  }, {
    min: 1.6,
    max: 3.2,
    height: -1,
    r: function r(θ) {
      return -496.7696 / (Math.sin(θ) - 1.493901 * Math.cos(θ));
    }
  }, {
    min: 3.2,
    max: 4.8,
    height: -1,
    r: function r(θ) {
      return -641.02615 / (Math.sin(θ) - 1.9114787 * Math.cos(θ));
    }
  }, {
    min: 4.8,
    max: 6.6,
    height: -1,
    r: function r(θ) {
      return -1020.3203 / (Math.sin(θ) - 2.9928111 * Math.cos(θ));
    }
  }, {
    min: 6.6,
    max: 11.2,
    height: -1,
    r: function r(θ) {
      return 6919.533 / (Math.sin(θ) + 19.3875915 * Math.cos(θ));
    }
  }, {
    min: 11.2,
    max: 42.6,
    height: -1,
    r: function r(θ) {
      return 1240.50705 / (Math.sin(θ) + 3.314747 * Math.cos(θ));
    }
  }, {
    min: 42.6,
    max: 68,
    height: -1,
    r: function r(θ) {
      return 437.37565 / (Math.sin(θ) + 0.5733725 * Math.cos(θ));
    }
  }, {
    min: 68,
    max: 84,
    height: -1,
    r: function r(θ) {
      return 351.0005 / (Math.sin(θ) - 0.0286525 * Math.cos(θ));
    }
  }, {
    min: 84,
    max: 85.6,
    height: -1,
    r: function r(θ) {
      return 340.789 / (Math.sin(θ) - 0.3046164 * Math.cos(θ));
    }
  }, {
    min: 85.6,
    max: 87,
    height: -1,
    r: function r(θ) {
      return 329.5441 / (Math.sin(θ) - 0.72330506 * Math.cos(θ));
    }
  }, {
    min: 87,
    max: 88.4,
    height: -1,
    r: function r(θ) {
      return 324.50638 / (Math.sin(θ) - 1.0040283 * Math.cos(θ));
    }
  }, {
    min: 88.4,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 328 / (Math.sin(θ) - 0.629411 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/ladodgers.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/miami.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -3285.092 / (Math.sin(θ) - 9.80624 * Math.cos(θ));
    }
  }, {
    min: 23.7,
    max: 27.1,
    height: -1,
    r: function r(θ) {
      return 5130.955 / (Math.sin(θ) + 14.1917 * Math.cos(θ));
    }
  }, {
    min: 27.1,
    max: 33.1,
    height: -1,
    r: function r(θ) {
      return 1260.2215 / (Math.sin(θ) + 3.099602 * Math.cos(θ));
    }
  }, {
    min: 33.1,
    max: 37.2,
    height: -1,
    r: function r(θ) {
      return 928.6866 / (Math.sin(θ) + 2.112672 * Math.cos(θ));
    }
  }, {
    min: 37.2,
    max: 41.2,
    height: -1,
    r: function r(θ) {
      return 822.69397 / (Math.sin(θ) + 1.78492 * Math.cos(θ));
    }
  }, {
    min: 41.2,
    max: 44.6,
    height: -1,
    r: function r(θ) {
      return 697.690 / (Math.sin(θ) + 1.380693 * Math.cos(θ));
    }
  }, {
    min: 44.6,
    max: 47.9,
    height: -1,
    r: function r(θ) {
      return 624.24997 / (Math.sin(θ) + 1.1315557 * Math.cos(θ));
    }
  }, {
    min: 47.9,
    max: 51.2,
    height: -1,
    r: function r(θ) {
      return 567.2532 / (Math.sin(θ) + 0.927191 * Math.cos(θ));
    }
  }, {
    min: 51.2,
    max: 51.3,
    height: -1,
    r: function r(θ) {
      return 123.3194 / (Math.sin(θ) - 0.7717922 * Math.cos(θ));
    }
  }, {
    min: 51.3,
    max: 51.6,
    height: -1,
    r: function r(θ) {
      return 163.1114 / (Math.sin(θ) - 0.618006 * Math.cos(θ));
    }
  }, {
    min: 51.6,
    max: 52.3,
    height: -1,
    r: function r(θ) {
      return 263.849 / (Math.sin(θ) - 0.2205658 * Math.cos(θ));
    }
  }, {
    min: 52.3,
    max: 53.6,
    height: -1,
    r: function r(θ) {
      return 333.1776 / (Math.sin(θ) + 0.061447 * Math.cos(θ));
    }
  }, {
    min: 53.6,
    max: 55,
    height: -1,
    r: function r(θ) {
      return 333.04836 / (Math.sin(θ) + 0.06472688 * Math.cos(θ));
    }
  }, {
    min: 55,
    max: 56.5,
    height: -1,
    r: function r(θ) {
      return 391.363 / (Math.sin(θ) + 0.32139203 * Math.cos(θ));
    }
  }, {
    min: 56.5,
    max: 59,
    height: -1,
    r: function r(θ) {
      return 457.485 / (Math.sin(θ) + 0.630953 * Math.cos(θ));
    }
  }, {
    min: 59,
    max: 60.8,
    height: -1,
    r: function r(θ) {
      return 389.587 / (Math.sin(θ) + 0.2903055 * Math.cos(θ));
    }
  }, {
    min: 60.8,
    max: 63.6,
    height: -1,
    r: function r(θ) {
      return 387.8902 / (Math.sin(θ) + 0.281246 * Math.cos(θ));
    }
  }, {
    min: 63.6,
    max: 68.2,
    height: -1,
    r: function r(θ) {
      return 367.932 / (Math.sin(θ) + 0.163124 * Math.cos(θ));
    }
  }, {
    min: 68.2,
    max: 72.1,
    height: -1,
    r: function r(θ) {
      return 360.0411 / (Math.sin(θ) + 0.112519 * Math.cos(θ));
    }
  }, {
    min: 72.1,
    max: 79.2,
    height: -1,
    r: function r(θ) {
      return 349.332 / (Math.sin(θ) + 0.00931917 * Math.cos(θ));
    }
  }, {
    min: 79.2,
    max: 84.3,
    height: -1,
    r: function r(θ) {
      return 339.562 / (Math.sin(θ) - 0.137541 * Math.cos(θ));
    }
  }, {
    min: 84.3,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 337 / (Math.sin(θ) - 0.212114 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/milwaukee.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return 4068.1011 / (Math.sin(θ) + 11.7916 * Math.cos(θ));
    }
  }, {
    min: 16.5,
    max: 16.8,
    height: -1,
    r: function r(θ) {
      return -60.8626 / (Math.sin(θ) - 0.47706 * Math.cos(θ));
    }
  }, {
    min: 16.8,
    max: 23.3,
    height: -1,
    r: function r(θ) {
      return 3834.475 / (Math.sin(θ) + 10.73232 * Math.cos(θ));
    }
  }, {
    min: 23.3,
    max: 35.5,
    height: -1,
    r: function r(θ) {
      return 1042.985 / (Math.sin(θ) + 2.60569 * Math.cos(θ));
    }
  }, {
    min: 35.5,
    max: 37.7,
    height: -1,
    r: function r(θ) {
      return -1107.4106 / (Math.sin(θ) - 4.237288 * Math.cos(θ));
    }
  }, {
    min: 37.7,
    max: 52.3,
    height: -1,
    r: function r(θ) {
      return 566.7112 / (Math.sin(θ) + Math.cos(θ));
    }
  }, {
    min: 52.3,
    max: 56.2,
    height: -1,
    r: function r(θ) {
      return 287.52 / (Math.sin(θ) - 0.130068 * Math.cos(θ));
    }
  }, {
    min: 56.2,
    max: 74,
    height: -1,
    r: function r(θ) {
      return 393.8230 / (Math.sin(θ) + 0.374126 * Math.cos(θ));
    }
  }, {
    min: 74,
    max: 85,
    height: -1,
    r: function r(θ) {
      return 358.50448 / (Math.sin(θ) + 0.027824 * Math.cos(θ));
    }
  }, {
    min: 85,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 334 / (Math.sin(θ) - 0.435742 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/minnesota.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -2731.998 / (Math.sin(θ) - 8.3292 * Math.cos(θ));
    }
  }, {
    min: 20,
    max: 38.5,
    height: -1,
    r: function r(θ) {
      return 1691.285 / (Math.sin(θ) + 4.5671 * Math.cos(θ));
    }
  }, {
    min: 38.5,
    max: 51.2,
    height: -1,
    r: function r(θ) {
      return 629.3765 / (Math.sin(θ) + 1.2001 * Math.cos(θ));
    }
  }, {
    min: 51.2,
    max: 67,
    height: -1,
    r: function r(θ) {
      return 382.741 / (Math.sin(θ) + 0.24243 * Math.cos(θ));
    }
  }, {
    min: 67,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 339 / (Math.sin(θ) - 0.05451 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/newyorkMets.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -2766.825 / (Math.sin(θ) - 8.3843195 * Math.cos(θ));
    }
  }, {
    min: 5.2,
    max: 7,
    height: -1,
    r: function r(θ) {
      return -371.523921 / (Math.sin(θ) - 1.204617 * Math.cos(θ));
    }
  }, {
    min: 7,
    max: 18.8,
    height: -1,
    r: function r(θ) {
      return -1855.73071 / (Math.sin(θ) - 5.52645 * Math.cos(θ));
    }
  }, {
    min: 18.8,
    max: 23.3,
    height: -1,
    r: function r(θ) {
      return 682.2307 / (Math.sin(θ) + 1.566132 * Math.cos(θ));
    }
  }, {
    min: 23.3,
    max: 29.5,
    height: -1,
    r: function r(θ) {
      return -40721.387 / (Math.sin(θ) - 119.616683 * Math.cos(θ));
    }
  }, {
    min: 29.5,
    max: 38.2,
    height: -1,
    r: function r(θ) {
      return 1281.67602 / (Math.sin(θ) + 3.1812751 * Math.cos(θ));
    }
  }, {
    min: 38.2,
    max: 49.1,
    height: -1,
    r: function r(θ) {
      return 575.86589 / (Math.sin(θ) + 0.9960149 * Math.cos(θ));
    }
  }, {
    min: 49.1,
    max: 82.1,
    height: -1,
    r: function r(θ) {
      return 358.6125 / (Math.sin(θ) + 0.1847292 * Math.cos(θ));
    }
  }, {
    min: 82.1,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 335 / (Math.sin(θ) - 0.30194697 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/newyorkYankees.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -752.7415 / (Math.sin(θ) - 2.397266 * Math.cos(θ));
    }
  }, {
    min: 3.2,
    max: 4.9,
    height: -1,
    r: function r(θ) {
      return -1341.4764 / (Math.sin(θ) - 4.22849 * Math.cos(θ));
    }
  }, {
    min: 4.9,
    max: 30.6,
    ...
    height: -1,
    r: function r(θ) {
      return 2683.6147 / (Math.sin(θ) + 7.70062 * Math.cos(θ));
    }
  }, {
    min: 36.1,
    max: 40.4,
    height: -1,
    r: function r(θ) {
      return 913.27186 / (Math.sin(θ) + 2.139572 * Math.cos(θ));
    }
  }, {
    min: 40.4,
    max: 44.4,
    height: -1,
    r: function r(θ) {
      return 707.36801 / (Math.sin(θ) + 1.4653105 * Math.cos(θ));
    }
  }, {
    min: 44.4,
    max: 48.4,
    height: -1,
    r: function r(θ) {
      return 600.6388 / (Math.sin(θ) + 1.096466 * Math.cos(θ));
    }
  }, {
    min: 48.4,
    max: 52.1,
    height: -1,
    r: function r(θ) {
      return 496.311752 / (Math.sin(θ) + 0.7103818 * Math.cos(θ));
    }
  }, {
    min: 52.1,
    max: 56.7,
    height: -1,
    r: function r(θ) {
      return 445.2994 / (Math.sin(θ) + 0.5053365 * Math.cos(θ));
    }
  }, {
    min: 56.7,
    max: 62.8,
    height: -1,
    r: function r(θ) {
      return 390.30014 / (Math.sin(θ) + 0.2548946 * Math.cos(θ));
    }
  }, {
    min: 62.8,
    max: 80.6,
    height: -1,
    r: function r(θ) {
      return 345.39856 / (Math.sin(θ) + 0.001719809 * Math.cos(θ));
    }
  }, {
    min: 80.6,
    max: 84.8,
    height: -1,
    r: function r(θ) {
      return 324.4985 / (Math.sin(θ) - 0.3638949 * Math.cos(θ));
    }
  }, {
    min: 84.8,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 316 / (Math.sin(θ) - 0.6421415 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/oakland.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -868.87638 / (Math.sin(θ) - 2.632959 * Math.cos(θ));
    }
  }, {
    min: 12,
    max: 22.3,
    height: -1,
    r: function r(θ) {
      return 911.9339 / (Math.sin(θ) + 2.32779 * Math.cos(θ));
    }
  }, {
    min: 22.3,
    max: 33.8,
    height: -1,
    r: function r(θ) {
      return 1753.07386 / (Math.sin(θ) + 4.853163 * Math.cos(θ));
    }
  }, {
    min: 33.8,
    max: 40.8,
    height: -1,
    r: function r(θ) {
      return 1043.5522 / (Math.sin(θ) + 2.617999 * Math.cos(θ));
    }
  }, {
    min: 40.8,
    max: 49.2,
    height: -1,
    r: function r(θ) {
      return 558.5246 / (Math.sin(θ) + Math.cos(θ));
    }
  }, {
    min: 49.2,
    max: 56.2,
    height: -1,
    r: function r(θ) {
      return 398.6068 / (Math.sin(θ) + 0.381972 * Math.cos(θ));
    }
  }, {
    min: 56.2,
    max: 67.7,
    height: -1,
    r: function r(θ) {
      return 361.22296 / (Math.sin(θ) + 0.2060512 * Math.cos(θ));
    }
  }, {
    min: 67.7,
    max: 78,
    height: -1,
    r: function r(θ) {
      return 391.759586 / (Math.sin(θ) + 0.429592 * Math.cos(θ));
    }
  }, {
    min: 78,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 330 / (Math.sin(θ) - 0.3798 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/philadelphia.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return 644.15 / (Math.sin(θ) + 1.277017 * Math.cos(θ));
    }
  }, {
    min: 50.7,
    max: 55.9,
    height: -1,
    r: function r(θ) {
      return 308.591 / (Math.sin(θ) - 0.02468 * Math.cos(θ));
    }
  }, {
    min: 55.9,
    max: 59.3,
    height: -1,
    r: function r(θ) {
      return 543.4657 / (Math.sin(θ) + 1.08071 * Math.cos(θ));
    }
  }, {
    min: 59.3,
    max: 88.3,
    ...
    height: -1,
    r: function r(θ) {
      return 325 / (Math.sin(θ) - 0.596191 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/pittsburgh.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -1758.947 / (Math.sin(θ) - 5.4827 * Math.cos(θ));
    }
  }, {
    min: 22.3,
    max: 34.1,
    height: -1,
    r: function r(θ) {
      return 1120.146 / (Math.sin(θ) + 2.8184 * Math.cos(θ));
    }
  }, {
    min: 34.1,
    max: 44.3,
    height: -1,
    r: function r(θ) {
      return 716 / (Math.sin(θ) + 1.56 * Math.cos(θ));
    }
  }, {
    min: 44.3,
    max: 58.5,
    height: -1,
    r: function r(θ) {
      return 478.809 / (Math.sin(θ) + 0.71785 * Math.cos(θ));
    }
  }, {
    min: 58.5,
    max: 59.6,
    height: -1,
    r: function r(θ) {
      return -4560.837 / (Math.sin(θ) - 24.0136 * Math.cos(θ));
    }
  }, {
    min: 59.6,
    max: 81.5,
    height: -1,
    r: function r(θ) {
      return 366.846 / (Math.sin(θ) + 0.089958 * Math.cos(θ));
    }
  }, {
    min: 81.5,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 321 / (Math.sin(θ) - 0.75751 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/sandiego.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -311.7359 / (Math.sin(θ) - 1.020242 * Math.cos(θ));
    }
  }, {
    min: 7.2,
    max: 27.8,
    ...
    height: -1,
    r: function r(θ) {
      return 1425.7353 / (Math.sin(θ) + 3.59492 * Math.cos(θ));
    }
  }, {
    min: 31.8,
    max: 38.3,
    height: -1,
    r: function r(θ) {
      return 740.2202 / (Math.sin(θ) + 1.568308 * Math.cos(θ));
    }
  }, {
    min: 38.3,
    max: 49.2,
    height: -1,
    r: function r(θ) {
      return 543.05468 / (Math.sin(θ) + 0.9402139 * Math.cos(θ));
    }
  }, {
    min: 49.2,
    max: 50.4,
    height: -1,
    r: function r(θ) {
      return 318.3662 / (Math.sin(θ) + 0.0718681 * Math.cos(θ));
    }
  }, {
    min: 50.4,
    max: 56.2,
    height: -1,
    r: function r(θ) {
      return 530.44852 / (Math.sin(θ) + 0.9611939 * Math.cos(θ));
    }
  }, {
    min: 56.2,
    max: 63.5,
    height: -1,
    r: function r(θ) {
      return 393.566469 / (Math.sin(θ) + 0.2972994 * Math.cos(θ));
    }
  }, {
    min: 63.5,
    max: 83.8,
    height: -1,
    r: function r(θ) {
      return 344.316 / (Math.sin(θ) + 0.0091096 * Math.cos(θ));
    }
  }, {
    min: 83.8,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 336 / (Math.sin(θ) - 0.2134522 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/sanfrancisco.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -697.339 / (Math.sin(θ) - 2.25676 * Math.cos(θ));
    }
  }, {
    min: 15,
    max: 18,
    height: -1,
    r: function r(θ) {
      return 946.0859 / (Math.sin(θ) + 2.4155 * Math.cos(θ));
    }
  }, {
    min: 18,
    max: 26,
    height: -1,
    r: function r(θ) {
      return -712.5915 / (Math.sin(θ) - 2.3890 * Math.cos(θ));
    }
  }, {
    min: 26,
    max: 55,
    height: -1,
    r: function r(θ) {
      return 564.2712 / (Math.sin(θ) + Math.cos(θ));
    }
  }, {
    min: 55,
    max: 86.5,
    height: -1,
    r: function r(θ) {
      return 347.526 / (Math.sin(θ) + 0.07905 * Math.cos(θ));
    }
  }, {
    min: 86.5,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 335 / (Math.sin(θ) - 0.513097 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/seattle.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -3502.437 / (Math.sin(θ) - 10.74367 * Math.cos(θ));
    }
  }, {
    min: 26.5,
    max: 47,
    height: -1,
    r: function r(θ) {
      return 825.224 / (Math.sin(θ) + 1.9153 * Math.cos(θ));
    }
  }, {
    min: 47,
    max: 59.6,
    height: -1,
    r: function r(θ) {
      return 414.71 / (Math.sin(θ) + 0.427476 * Math.cos(θ));
    }
  }, {
    min: 59.6,
    max: 66.5,
    height: -1,
    r: function r(θ) {
      return 377.4922 / (Math.sin(θ) + 0.2382 * Math.cos(θ));
    }
  }, {
    min: 66.5,
    max: 88.5,
    height: -1,
    r: function r(θ) {
      return 336.558 / (Math.sin(θ) - 0.037016 * Math.cos(θ));
    }
  }, {
    min: 88.5,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 331 / (Math.sin(θ) - 0.6671 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/stlouis.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -436.689 / (Math.sin(θ) - 1.3173 * Math.cos(θ));
    }
  }, {
    min: 3.3,
    max: 25.6,
    ...
    height: -1,
    r: function r(θ) {
      return 857.076 / (Math.sin(θ) + 1.995805 * Math.cos(θ));
    }
  }, {
    min: 39.9,
    max: 50,
    height: -1,
    r: function r(θ) {
      return 569.534 / (Math.sin(θ) + 1.04571 * Math.cos(θ));
    }
  }, {
    min: 50,
    max: 64,
    height: -1,
    r: function r(θ) {
      return 434.192 / (Math.sin(θ) + 0.514 * Math.cos(θ));
    }
  }, {
    min: 64,
    max: 88.4,
    ...
    height: -1,
    r: function r(θ) {
      return 330 / (Math.sin(θ) - 1.73033 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/tampa.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -357.101 / (Math.sin(θ) - 1.109 * Math.cos(θ));
    }
  }, {
    min: 1.7,
    max: 33.75,
    ...
    height: -1,
    r: function r(θ) {
      return 1678.156 / (Math.sin(θ) + 4.403 * Math.cos(θ));
    }
  }, {
    min: 36.2,
    max: 55,
    height: -1,
    r: function r(θ) {
      return 596.756 / (Math.sin(θ) + 1.09406 * Math.cos(θ));
    }
  }, {
    min: 55,
    max: 56.4,
    height: -1,
    r: function r(θ) {
      return 275.106 / (Math.sin(θ) - 0.2654 * Math.cos(θ));
    }
  }, {
    min: 56.4,
    max: 58,
    height: -1,
    r: function r(θ) {
      return 477.013 / (Math.sin(θ) + 0.6444 * Math.cos(θ));
    }
  }, {
    min: 58,
    max: 86,
    height: -1,
    r: function r(θ) {
      return 342.4305 / (Math.sin(θ) + 0.011121 * Math.cos(θ));
    }
  }, {
    min: 86,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 315 / (Math.sin(θ) - 1.13533 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/texas.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -432.031 / (Math.sin(θ) - 1.3252 * Math.cos(θ));
    }
  }, {
    min: 4,
    max: 24,
    ...
    height: -1,
    r: function r(θ) {
      return 543.706 / (Math.sin(θ) + 1.1376 * Math.cos(θ));
    }
  }, {
    min: 26.1,
    max: 34.3,
    ...
    height: -1,
    r: function r(θ) {
      return 565.81 / (Math.sin(θ) + Math.cos(θ));
    }
  }, {
    min: 53.1,
    max: 64.3,
    height: -1,
    r: function r(θ) {
      return 416.6997 / (Math.sin(θ) + 0.38598 * Math.cos(θ));
    }
  }, {
    min: 64.3,
    max: 84.2,
    ...
    height: -1,
    r: function r(θ) {
      return 331 / (Math.sin(θ) - 0.51319 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/toronto.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -1725.1974 / (Math.sin(θ) - 5.2597 * Math.cos(θ));
    }
  }, {
    min: 20,
    max: 32.5,
    height: -1,
    r: function r(θ) {
      return 2160.354 / (Math.sin(θ) + 5.7667 * Math.cos(θ));
    }
  }, {
    min: 32.5,
    max: 57.5,
    ...
    height: -1,
    r: function r(θ) {
      return 374.6529 / (Math.sin(θ) + 0.17341 * Math.cos(θ));
    }
  }, {
    min: 70,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 328 / (Math.sin(θ) - 0.19012 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
},{}],"js/washington.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  walls: [{
    ...
    height: -1,
    r: function r(θ) {
      return -1192.9 / (Math.sin(θ) - 3.56091 * Math.cos(θ));
    }
  }, {
    min: 13.1,
    max: 46.5,
    height: -1,
    r: function r(θ) {
      return 1018.837 / (Math.sin(θ) + 2.609847 * Math.cos(θ));
    }
  }, {
    min: 46.5,
    max: 57.9,
    height: -1,
    r: function r(θ) {
      return 372.8599 / (Math.sin(θ) + 0.286983 * Math.cos(θ));
    }
  }, {
    min: 57.9,
    max: 59,
    height: -1,
    r: function r(θ) {
      return 1089.6378 / (Math.sin(θ) + 3.903208 * Math.cos(θ));
    }
  }, {
    min: 59,
    max: 74.1,
    height: -1,
    r: function r(θ) {
      return 383.87617 / (Math.sin(θ) + 0.297133 * Math.cos(θ));
    }
  }, {
    min: 74.1,
    max: 74.2,
    height: -1,
    r: function r(θ) {
      return 163.401 / (Math.sin(θ) - 1.88975 * Math.cos(θ));
    }
  }, {
    min: 74.2,
    max: 76.5,
    height: -1,
    r: function r(θ) {
      return 377.1893 / (Math.sin(θ) + 0.261412 * Math.cos(θ));
    }
  }, {
    min: 76.5,
    max: 90,
    height: -1,
    r: function r(θ) {
      return 336 / (Math.sin(θ) - 0.221987 * Math.cos(θ));
    }
  }]
};
exports.default = _default;
...
var _arizona = _interopRequireDefault(require("./arizona"));

var _atlanta = _interopRequireDefault(require("./atlanta"));

var _baltimore = _interopRequireDefault(require("./baltimore"));

var _boston = _interopRequireDefault(require("./boston"));

var _chicagocubs = _interopRequireDefault(require("./chicagocubs"));

var _chicagowhitesox = _interopRequireDefault(require("./chicagowhitesox"));

var _cincinnati = _interopRequireDefault(require("./cincinnati"));

var _cleveland = _interopRequireDefault(require("./cleveland"));

var _colorado = _interopRequireDefault(require("./colorado"));

var _detroit = _interopRequireDefault(require("./detroit"));

var _houston = _interopRequireDefault(require("./houston"));

var _kansascity = _interopRequireDefault(require("./kansascity"));

var _laangels = _interopRequireDefault(require("./laangels"));

var _ladodgers = _interopRequireDefault(require("./ladodgers"));

var _miami = _interopRequireDefault(require("./miami"));

var _milwaukee = _interopRequireDefault(require("./milwaukee"));

var _minnesota = _interopRequireDefault(require("./minnesota"));

var _newyorkMets = _interopRequireDefault(require("./newyorkMets"));

var _newyorkYankees = _interopRequireDefault(require("./newyorkYankees"));

var _oakland = _interopRequireDefault(require("./oakland"));

var _philadelphia = _interopRequireDefault(require("./philadelphia"));

var _pittsburgh = _interopRequireDefault(require("./pittsburgh"));

var _sandiego = _interopRequireDefault(require("./sandiego"));

var _sanfrancisco = _interopRequireDefault(require("./sanfrancisco"));

var _seattle = _interopRequireDefault(require("./seattle"));

var _stlouis = _interopRequireDefault(require("./stlouis"));

var _tampa = _interopRequireDefault(require("./tampa"));

var _texas = _interopRequireDefault(require("./texas"));

var _toronto = _interopRequireDefault(require("./toronto"));

var _washington = _interopRequireDefault(require("./washington"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = {
  arizona: _arizona.default,
  atlanta: _atlanta.default,
  baltimore: _baltimore.default,
  boston: _boston.default,
  chicagocubs: _chicagocubs.default,
  chicagowhitesox: _chicagowhitesox.default,
  cincinnati: _cincinnati.default,
  cleveland: _cleveland.default,
  colorado: _colorado.default,
  detroit: _detroit.default,
  houston: _houston.default,
  kansascity: _kansascity.default,
  laangels: _laangels.default,
  ladodgers: _ladodgers.default,
  miami: _miami.default,
  milwaukee: _milwaukee.default,
  minnesota: _minnesota.default,
  newyorkMets: _newyorkMets.default,
  newyorkYankees: _newyorkYankees.default,
  oakland: _oakland.default,
  philadelphia: _philadelphia.default,
  pittsburgh: _pittsburgh.default,
  sandiego: _sandiego.default,
  sanfrancisco: _sanfrancisco.default,
  seattle: _seattle.default,
  stlouis: _stlouis.default,
  tampa: _tampa.default,
  texas: _texas.default,
  toronto: _toronto.default,
  washington: _washington.default
};
exports.default = _default;
},{"./arizona":"js/arizona.js","./atlanta":"js/atlanta.js","./baltimore":"js/baltimore.js","./boston":"js/boston.js","./chicagocubs":"js/chicagocubs.js","./chicagowhitesox":"js/chicagowhitesox.js","./cincinnati":"js/cincinnati.js","./cleveland":"js/cleveland.js","./colorado":"js/colorado.js","./detroit":"js/detroit.js","./houston":"js/houston.js","./kansascity":"js/kansascity.js","./laangels":"js/laangels.js","./ladodgers":"js/ladodgers.js","./miami":"js/miami.js","./milwaukee":"js/milwaukee.js","./minnesota":"js/minnesota.js","./newyorkMets":"js/newyorkMets.js","./newyorkYankees":"js/newyorkYankees.js","./oakland":"js/oakland.js","./philadelphia":"js/philadelphia.js","./pittsburgh":"js/pittsburgh.js","./sandiego":"js/sandiego.js","./sanfrancisco":"js/sanfrancisco.js","./seattle":"js/seattle.js","./stlouis":"js/stlouis.js","./tampa":"js/tampa.js","./texas":"js/texas.js","./toronto":"js/toronto.js","./washington":"js/washington.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var sluggify = function sluggify(str) {
  return str.replace(' ', '-');
};
...
function setup(group) {
  ...
  plotSq(0, 0, 90, 'green'); // infield circs
  ...
  var baseOffset = baseWidth / 2; // to center rects
  ...
  plotSq(0, 90 - baseOffset, baseWidth, 'white'); // The pitching rubber is 18 inches back from the center of the mound
...
function plotField(fieldData, group) {
  ...
  var _loop = function _loop(i) {
    ...
    var wallData = fieldData.walls.find(function (wallSegment) {
      var min = wallSegment.min,
          max = wallSegment.max;
  ...
  wall.on('mouseover', function (e) {
    ...
    wall.attr('stroke-width', 4).attr('opacity', 1);
  });
  wall.on('mouseleave', function (e) {
    document.getElementById('info-name').innerHTML = '';
    document.getElementById('info-team').innerHTML = '';
    wall.attr('stroke-width', 1).attr('opacity', 0.5);
  });
}

function updateVisible() {
  d3.selectAll('#team-select input').each(function (d) {
    var parkName = this.dataset.name;
    var parkPath = d3.select("path[data-park-name=\"".concat(parkName, "\"]"));
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var group = svg.append("g").attr("transform", "translate(" + margin.left + "," + (height + margin.top) + ") scale(1,-1)");
  setup(group);
  ...
  for (var _i = 0, _Object$values = Object.values(_js.default); _i < _Object$values.length; _i++) {
    ...
    var _field$team = field.team,
        ...
        city = _field$team.city;
    var teamSelectDiv = d3.select("#team-select #".concat(league, " #").concat(league, "-").concat(division)).append("div");
    teamSelectDiv.append("input").attr("data-name", field.name).attr("id", sluggify(field.name)).attr("type", "checkbox").property("checked", true).on("change", updateVisible);
    teamSelectDiv.append('label').attr('for', sluggify(field.name)).html("<span class=\"team\">".concat(city, " ").concat(field.team.name, "</span><span class=\"field\">").concat(field.name, "</span>"));
  }
  ...
  svg.on('mousemove', function () {
    ...
    var xPos = mx - margin.left;
    var yPos = 450 - my - margin.top;
    xPosSpan.innerHTML = xPos;
    yPosSpan.innerHTML = yPos;
    distSpan.innerHTML = Math.sqrt(Math.pow(xPos, 2) + Math.pow(yPos, 2)).toFixed(2);
  });
});
},{"d3":"node_modules/d3/index.js","./js":"js/index.js"}],"../../.nvm/versions/node/v8.2.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v8.2.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
